...
const projects = [
  {
    ...
    cardImage: "R.png",
    description: "A real-time chat app built using basic node.js, mogonoDb and Socket.io. It is an App where you can easily chat with your friends as well you share files also.",
  ...
  {
    title: "The Dice Game",
    cardImage: "Dice-game.png",
    description: "A game where pepole can play with dice.",
  ...
  {
    title: "Drum Kit",
    cardImage: "drum-kit.jpg",
    description: "Virtual Drum Pad built using javascript",
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "",
    Githublink: "",
  },
  {
    ...
    cardImage: "QR.png",
    description: "It allow user to input /urls to generate QR Code.",
  ...
  },
  {
    ...
    cardImage: "Sundown.png",
    description: "A clone Website built using Html, CSS, JavaScript.",
    tagimg:
  ...
  },
  {
    ...
    cardImage: "portfolio.jpeg",
    description: "Portfolio built using JavaScript.",
